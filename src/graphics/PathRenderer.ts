 ...
 * Extracted from GameEnvironment to reduce file size.
 */
export class PathRenderer {
  ...
  /**
   * Draw the complete canyon path with all layers
   */
  draw(): void {
  ...
  /**
   * Draw a single path layer (rectangle segments with circular joints)
   */
  ...
  /**
   * Add rocky edge details along the canyon walls
   */
  ...
  /**
   * Add small pebbles and details on the path surface
   */
