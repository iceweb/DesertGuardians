...
export const TOWER_CONFIGS: Record<string, TowerConfig> = {
  ...
  icetower_1: {
    ...
    level: 1,
    upgradeCost: 65,
    description: '80% armor penetration. Slows 40% for 2.6s. Prefers unslowed targets.',
    stats: {
      range: 180,
      fireRate: 1400,
      damage: 8,
  ...
  icetower_2: {
    ...
    level: 2,
    upgradeCost: 130,
    description: '80% armor pen. 50% slow for 3.25s. Essential crowd control.',
    stats: {
      range: 200,
      fireRate: 1300,
      damage: 12,
  ...
  icetower_3: {
    ...
    level: 3,
    upgradeCost: 240,
    description: '80% armor pen. 60% slow for 3.9s. Core for late-game.',
    stats: {
      range: 220,
      fireRate: 1200,
      damage: 18,
  ...
  poison_1: {
    ...
    level: 1,
    upgradeCost: 65,
    description: '80% armor pen. DoT: 5/s for 6.5s, stacks 3x. Best vs armored!',
    stats: {
      range: 200,
      fireRate: 1800,
      damage: 5,
  ...
  poison_2: {
    ...
    level: 2,
    upgradeCost: 130,
    description: '80% armor pen. DoT: 8/s for 6.5s, stacks 3x. Melts armored waves.',
    stats: {
      range: 220,
      fireRate: 1650,
      damage: 8,
  ...
  poison_3: {
    ...
    level: 3,
    upgradeCost: 240,
    description: '80% armor pen. DoT: 12/s for 7.5s, stacks 3x. Essential for bosses.',
    stats: {
      range: 240,
      fireRate: 1500,
      damage: 12,
  ...
  icetower_4: {
    ...
    level: 4,
    upgradeCost: 500,
    description: '80% armor pen. 65% slow, 4.5s. Ice Trap/Frost Nova/Deep Freeze.',
    stats: {
      range: 240,
      fireRate: 1100,
      damage: 24,
