...
export const TOWER_ABILITIES: Record<TowerBranch, AbilityDefinition[]> = {
  rockcannon: [
    {
      ...
      name: 'Aftershock',
      description: '3 secondary explosions around impact (60% damage)',
      triggerChance: 0.25,
      icon: { type: AbilityIconType.EXPLOSION, primaryColor: 0xffaa00, secondaryColor: 0xff6600 },
      effectParams: { count: 3, radius: 50, damageMultiplier: 0.6, duration: 500 },
    },
    {
      id: 'cannon_tremor',
      name: 'Tremor',
      description: 'Ground zone deals 80 damage AND slows enemies by 30%',
      triggerChance: 0.2,
      icon: { type: AbilityIconType.TREMOR, primaryColor: 0x8b4513, secondaryColor: 0x5c4033 },
      effectParams: { radius: 85, duration: 3000, damage: 80, slowPercent: 0.3 },
    },
    {
      id: 'cannon_shrapnel',
      name: 'Shrapnel Burst',
      description: '6 fragments dealing 45% damage each',
      triggerChance: 0.3,
      icon: { type: AbilityIconType.SHRAPNEL, primaryColor: 0x808080, secondaryColor: 0x5a5a5a },
      effectParams: { count: 6, radius: 8, damageMultiplier: 0.45 },
    },
  ],
  sniper: [
    {
  ...
  poison: [
    ...
    },
    {
      ...
      description: 'At max stacks, explode for 80 damage',
      triggerChance: 0.15,
      icon: { type: AbilityIconType.FLASK, primaryColor: 0x32cd32, secondaryColor: 0x00ff00 },
      effectParams: { damage: 80, radius: 60 },
    },
    {
      id: 'poison_corrosive',
      name: 'Corrosive Acid',
  ...
  aura: [
    ...
    },
    {
      ...
      description: 'Nearby towers have 10% chance to Multicast',
      triggerChance: 1.0,
      isPassive: true,
      icon: { type: AbilityIconType.ECHO, primaryColor: 0x9966ff, secondaryColor: 0xcc99ff },
      effectParams: { multicastChance: 0.1 },
    },
  ],
  archer: [
    {
